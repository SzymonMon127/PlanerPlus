...
class MyUsersListActivity : AppCompatActivity(), ValueEventListener {
    @SuppressLint("ObjectAnimatorBinding")
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_my_users_list)
        ...
        mainActivityRecyclerView = findViewById(R.id.rv_Users_list)
    ...
    private fun usersManagment(ThisUid:String?, ThisName:String?) {
        ...
        alert.setMessage(this@MyUsersListActivity.resources.getString(R.string.decide)+"\n\n"+ this@MyUsersListActivity.resources.getString(R.string.user) +" "+ThisName)
        alert.setTitle(this@MyUsersListActivity.resources.getString(R.string.userManagment))

        alert.setPositiveButton(
            this@MyUsersListActivity.resources.getString(R.string.showProfile)
        ) { dialog: DialogInterface?, whichButton: Int ->

            val intent = Intent(this@MyUsersListActivity, ProfilUserActivity::class.java)
        ...
        alert.setNeutralButton(
            this@MyUsersListActivity.resources.getString(R.string.deleteProfile)
        ) { dialog: DialogInterface?, whichButton: Int ->
            firebaseDatabase!!.reference.child("Providers").child(id!!).child("UsersList").child(ThisUid!!).removeValue()
            Toast.makeText(applicationContext, this@MyUsersListActivity.resources.getString(R.string.deleted), Toast.LENGTH_SHORT).show()

        }

        alert.setNegativeButton(
            this@MyUsersListActivity.resources.getString(R.string.cancel)
...
0
            ...
            Toast.makeText(
                this@MyUsersListActivity,
                this@MyUsersListActivity.resources.getString(R.string.firebaseInitFail),
                Toast.LENGTH_LONG
            ).show()
        }
    }
