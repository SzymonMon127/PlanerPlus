...
class RequestsListActivity : AppCompatActivity(), ValueEventListener {
    ...
    override fun onPause() {
        super.onPause()
        firebaseDatabase!!.reference.child("Providers").child(id!!).child("Requests").orderByChild("name")
    ...
    private fun usersManagment(ThisUid:String?, ThisName:String?) {
        ...
        alert.setMessage(this@RequestsListActivity.resources.getString(R.string.decide)+"\n\n"+ this@RequestsListActivity.resources.getString(R.string.user) +" "+ThisName)
        alert.setTitle(this@RequestsListActivity.resources.getString(R.string.userManagment))

        alert.setPositiveButton(
            this@RequestsListActivity.resources.getString(R.string.showProfile)
        ) { dialog: DialogInterface?, whichButton: Int ->

            val intent = Intent(this@RequestsListActivity, ProfilUserActivity::class.java)
        ...
        alert.setNeutralButton(
            this@RequestsListActivity.resources.getString(R.string.deleteProfileFromList)
        ) { dialog: DialogInterface?, whichButton: Int ->
            firebaseDatabase!!.reference.child("Providers").child(id!!).child("Requests").child(ThisUid!!).removeValue()
            Toast.makeText(applicationContext, this@RequestsListActivity.resources.getString(R.string.deleted), Toast.LENGTH_SHORT).show()

        }

        alert.setNegativeButton(
            this@RequestsListActivity.resources.getString(R.string.cancel)
    ...
    override fun onDataChange(snapshot: DataSnapshot) {
        try {
            ...
            Toast.makeText(
                ...
                this@RequestsListActivity.resources.getString(R.string.firebaseInitFail),
                Toast.LENGTH_LONG
            ).show()
        }
    }
